...
//большой фон слотов    
        ...
        MainTDInv[x][itdm_Strip][1] = TextDrawCreate(20.00, 42.00, InventoryTextTD[4][x]); //Рюкзак
...
//ObjectInfo
        ...
        for(new x_s; x_s < 5; x_s++) {
            ...
            MainTDInv[x][itdm_Stats_Strip][x_s] = TextDrawCreate(244.0, PosY - 3.0, "_");//разделительная полоса инфо
        ...
        MainTDInv[x][itdm_Stats_Strip][5] = TextDrawCreate(256.00-17.0, 196.00, "_");//разделительная полоса инфо
...
//IN_Indicators
        ...
        for(new x_i; x_i < 4; x_i++) {
            ...
            MainTDInv[x][itdm_IndicatorStrip][x_i] = TextDrawCreate(552.0, PosY - 3.0, "_");//разделительная полоса инфо
