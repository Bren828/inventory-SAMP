...
//IN_Hands
        ...
        for(new x_w; x_w < 2; x_w++) {
            ...
            if(x_w == 0) {
                TextDrawTextSize(GlobalInventory[x][giIN_Hands_Slot_Fon][x_w], 99.7000, 34.9000);   
            }
            else {
                TextDrawTextSize(GlobalInventory[x][giIN_Hands_Slot_Fon][x_w], 29.7000, 34.9000);   
            }
            ...
            if(x_w == 0) {
                TextDrawTextSize(GlobalInventory[x][giIN_Hands_Slot_Icon][x_w], 98.7000, 33.8997);
            }
            else {
                TextDrawTextSize(GlobalInventory[x][giIN_Hands_Slot_Icon][x_w], 28.7000, 33.8997);
            }
